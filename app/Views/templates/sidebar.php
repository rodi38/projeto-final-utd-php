          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">              
                <li class="nav-item">
                  <a href="<?=base_url();?>/livros/listar" class="nav-link">
                  <span class="iconify" data-icon="bi:file-earmark-pdf-fill" data-width="23" data-height="23"></span>
                    <p>Listar</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="<?=base_url();?>/livros/inserir" class="nav-link">
                  <span class="iconify" data-icon="bi:file-earmark-pdf-fill" data-width="23" data-height="23"></span>
                    <p>Inserir</p>
                  </a>
                </li>
            ...
            <li class="nav-item"><a href="<?=base_url();?>/UsuariosController/lista" class="nav-link"><span class="iconify" data-icon="jam:users" data-width="26" data-height="26"></span> <p> Usuarios </p></a> </li>
