                   ...
                   <tbody class=""> 
                      <?php  foreach ($result as $key => $value): ?>                          
                          <tr>                            
                             ...
                             <td>
                               <a class="btn btn-warning btn-xs" href="<?=base_url();?>/UsuariosController/editar/<?=$value['ID_USER'];?>" class="btn btn-default"><i class="fa fa-edit"> </i> </a>
                               <a class="btn btn-danger btn-xs" href="<?=base_url();?>/UsuariosController/delete/<?=$value['ID_USER'];?>" class="btn btn-default"><i class="fa fa-trash"> </i> </a>
                             </td>
                          </tr>
                      <?php  endforeach; ?>
                   </tbody>
